      ...
      <div className="w-full max-w-full">
        {categories.map((category) => {
          ...
          return (
            <div
              key={category.name}
              className="items-center space-x-4 mb-4 category"
              style={{ 
            ...
            >
              <div className="absolute top-0 left-0 w-full bg-gray-100 p-2 rounded-t cursor-pointer">
                <div className="font-bold text-md text-gray-400">{category.name}</div>
              </div>
  ...
  return (
    ...
    >
      <div className="w-full max-w-[1200px] mx-auto">
        ...
        <div className="bg-white shadow-md rounded-lg w-full mb-6">
          <div className="relative mb-4 p-4">
            {/* Centered Start Year and End Year */}
...
>
  {hoveredEventDetails ? (
    ...
    <div className="text-gray-500">Hover over an event to see details</div>
  )}
</div>
        ...
        >
          ...
          <div className="relative overflow-y-auto" style={{ height: 'calc(100% - 30px)' }}>
            <div className="min-h-full px-0 py-4">
